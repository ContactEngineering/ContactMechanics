...
def augmented_lagrangian(objective_fun, eq_const_fun, solver='hybr', options=dict()):
    """
    Keyword Arguments:
    objective_fun -- 
    eq_const_fun  -- 
...
def augmented_lagrangian(fun, x0, constraints, mu_0=None, lamb_0=None,
                         ...
                         options=None):
    """ Implements the augmented lagrangian for equality constraints. The arguments have the same meaning as in scipy.optimize.minimize
    Keyword Arguments:

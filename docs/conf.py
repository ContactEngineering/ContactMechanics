...
# -*- coding: utf-8 -*-
#
# ContactMechanics documentation build configuration file, created by
...
project = 'ContactMechanics'
copyright = '2015-2020 The Authors'
authors = ['Till Junge', 'Lars Pastewka', 'Michael Röttger',
           'Antoine Sanner']
...
latex_documents = [
    (master_doc, 'ContactMechanics.tex', 'ContactMechanics Documentation',
     'Pastewka', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'ContactMechanics', 'ContactMechanics Documentation',
     authors, 'ContactMechanics', 'One line description of project.',
     'Miscellaneous'),
]
